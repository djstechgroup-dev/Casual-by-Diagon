...
class _UserHighScoresState extends State<UserHighScores> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> highscoreWidgetsList = [
              ...
              child: Column(
                children: [
                  AnimatedContainer(
                    ...
                    transform: Matrix4.translationValues(0, startShowing ? 0 : -screenHeight / 4, 0),
                    child: Text(
                      "High Scores",
                      style: TextStyle(
                        fontFamily: "Inter",
                  ...
                  Column(
                    children: [
                      for(int i = 0; i < highscoreWidgetsList.length; i++)...<Widget>[
                        AnimatedContainer(
                          duration: Duration(milliseconds: 400 + i * 100),
                          curve: Curves.easeInOut,
                          transform: Matrix4.translationValues(startShowing ? 0 : screenWidth, 0, 0),
                          child: highscoreWidgetsList[i],
                        ),
                      ],
                    ],
                  ),
