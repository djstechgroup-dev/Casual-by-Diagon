...
class _UserReferralScreenState extends State<UserReferralScreen> {
  ...
  double avatarScale1 = 0;
  double avatarScale2 = 0;

  int userRefferals = 0;

  int avatar1 = Random().nextInt(13) + 1;
  int avatar2 = Random().nextInt(13) + 1;
  int avatar3 = Random().nextInt(13) + 1;
        ...
        children: [
          SingleChildScrollView(
            ...
            child: Stack(
              children: [
                AnimatedContainer(
                  height: containerY + screenHeight / 3,
                  width: screenWidth,
                  duration: const Duration(milliseconds: 800),
                  transform: Matrix4.translationValues(0, -screenHeight / 3, 0),
                  onEnd: () {
                    if(mounted) {
                      setState(() {
                        avatarOpacity = 1;
                        ...
                        child: ClipRRect(
                          ...
                          child: Align(
                            ...
                            child: Stack(
                              alignment: Alignment.bottomRight,
                              children: [
                                avatars(avatar1, screenHeight / 2.4 / 2.6, 12, 12),
                                avatars(avatar2, avatarScale1, -screenWidth / 20, -screenHeight / 2.6 / 2),
                                avatars(avatar3, avatarScale2, -screenWidth / 2.5, -screenHeight / 2.6 / 10),
                              ],
                            ),
                          ),
                        ),
  ...
  Widget avatars(int avatar, double size, double offsetX, double offsetY) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(
            "assets/images/avatars/avatar$avatar.png",
          ),
          fit: BoxFit.cover,
        ),
      ),
